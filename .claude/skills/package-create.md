...
`rules/package.md`). The field MUST match the MkDocs field folder of the unit's documentation page;
a unit documented in more than one field goes into `common`. If no existing field fits, ask the user
