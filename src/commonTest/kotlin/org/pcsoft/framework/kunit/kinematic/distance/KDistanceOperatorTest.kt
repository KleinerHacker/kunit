...
class KDistanceOperatorTest {
    ...
    @Test
    fun `plus matrix`() = forEachCase(lengthPairs()) { case ->
        `plus matrix`(case[0] as KLengthUnitInstance, case[1] as Double, case[2] as KLengthUnitInstance, case[3] as Double)
    }

    private fun `plus matrix`(a: KLengthUnitInstance, aBase: Double, b: KLengthUnitInstance, bBase: Double) {
    ...
    @Test
    fun `minus matrix`() = forEachCase(lengthPairs()) { case ->
        `minus matrix`(case[0] as KLengthUnitInstance, case[1] as Double, case[2] as KLengthUnitInstance, case[3] as Double)
    }

    private fun `minus matrix`(a: KLengthUnitInstance, aBase: Double, b: KLengthUnitInstance, bBase: Double) {
    ...
    @Test
    fun `times gives area`() = forEachCase(lengthPairs()) { case ->
        `times gives area`(case[0] as KLengthUnitInstance, case[1] as Double, case[2] as KLengthUnitInstance, case[3] as Double)
    }

    private fun `times gives area`(a: KLengthUnitInstance, aBase: Double, b: KLengthUnitInstance, bBase: Double) {
    ...
    @Test
    fun `div cancels to ratio`() = forEachCase(lengthPairs()) { case ->
        `div cancels to ratio`(case[0] as KLengthUnitInstance, case[1] as Double, case[2] as KLengthUnitInstance, case[3] as Double)
    }

    private fun `div cancels to ratio`(a: KLengthUnitInstance, aBase: Double, b: KLengthUnitInstance, bBase: Double) {
    ...
    @Test
    fun `pow 2 gives area`() = forEachCase(tokens()) { case ->
        `pow 2 gives area`(case[0] as KLengthUnitInstance, case[1] as Double)
    }

    private fun `pow 2 gives area`(token: KLengthUnitInstance, base: Double) {
