...
class KDistanceUnitTest {
    ...
    @Test
    fun `conversion matrix`() = forEachCase(lengthPairs()) { case ->
        `conversion matrix`(case[0] as KLengthUnitInstance, case[1] as Double, case[2] as KLengthUnitInstance, case[3] as Double)
    }

    private fun `conversion matrix`(from: KLengthUnitInstance, fromBase: Double, to: KLengthUnitInstance, toBase: Double) {
