...
class KTimeOperatorTest {
    ...
    @Test
    fun `plus and minus matrix`() = forEachCase(pairs()) { case ->
        `plus and minus matrix`(case[0] as KTimeUnitInstance, case[1] as Double, case[2] as KTimeUnitInstance, case[3] as Double)
    }

    private fun `plus and minus matrix`(a: KTimeUnitInstance, ab: Double, b: KTimeUnitInstance, bb: Double) {
