...
class KElectricMobilityUnitTest {
    ...
    fun `unit conversion`() = forEachCase(tokenArgs()) { case ->
        `unit conversion`(case[0] as String, case[1] as KElectricMobilityUnitInstance, case[2] as KElectricMobilityUnit)
    }

    private fun `unit conversion`(name: String, token: KElectricMobilityUnitInstance, unit: KElectricMobilityUnit) {
