...
class KElectricCurrentUnitTest {
    ...
    fun `unit conversion`() = forEachCase(tokenArgs()) { case ->
        `unit conversion`(case[0] as String, case[1] as KElectricCurrentUnitInstance, case[2] as Double)
    }

    private fun `unit conversion`(name: String, token: KElectricCurrentUnitInstance, base: Double) {
