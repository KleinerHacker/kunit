...
class KChargeUnitTest {
    ...
    fun `unit conversion`() = forEachCase(tokenArgs()) { case ->
        `unit conversion`(case[0] as String, case[1] as KChargeUnitInstance, case[2] as KChargeUnit)
    }

    private fun `unit conversion`(name: String, token: KChargeUnitInstance, unit: KChargeUnit) {
