...
class KElectricDipoleMomentUnitSystemTest {
    ...
    fun `construction and round-trip`() = forEachCase(tokenArgs()) { case ->
        `construction and round-trip`(case[0] as KElectricDipoleMomentUnitInstance, case[1] as Double)
    }

    private fun `construction and round-trip`(token: KElectricDipoleMomentUnitInstance, base: Double) {
