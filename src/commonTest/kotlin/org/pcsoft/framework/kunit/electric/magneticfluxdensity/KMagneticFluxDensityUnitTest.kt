...
class KMagneticFluxDensityUnitTest {
    ...
    fun `unit conversion`() = forEachCase(tokenArgs()) { case ->
        `unit conversion`(case[0] as String, case[1] as KMagneticFluxDensityUnitInstance, case[2] as KMagneticFluxDensityUnit)
    }

    private fun `unit conversion`(name: String, token: KMagneticFluxDensityUnitInstance, unit: KMagneticFluxDensityUnit) {
