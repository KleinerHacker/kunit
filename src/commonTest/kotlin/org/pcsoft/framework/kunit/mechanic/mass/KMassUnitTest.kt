...
class KMassUnitTest {
    ...
    fun `unit conversion`() = forEachCase(tokenArgs()) { case ->
        `unit conversion`(case[0] as String, case[1] as KMassUnitInstance, case[2] as Double)
    }

    private fun `unit conversion`(name: String, token: KMassUnitInstance, base: Double) {
