...
// Bare unit references, usable both as a KUnitTarget (e.g. `t.valueIn(hours)`) and as the `unit`
...
/** Bare reference to [KTimeUnit.SECOND], for use with [valueIn][KTimeUnitInstance.valueIn] or the prefix `infix` functions. */
