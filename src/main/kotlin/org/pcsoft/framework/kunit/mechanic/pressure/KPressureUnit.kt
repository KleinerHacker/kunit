 ...
 * fixed factor is [org.pcsoft.framework.kunit.mechanic.pressure.PA_IN_BASE] and is applied by the
...
enum class KPressureUnit(override val symbol: String, override val baseValue: Double) : KUnit {
    ...
    companion object {
         ...
         * are normalized to pascals (via the [org.pcsoft.framework.kunit.mechanic.pressure.PA_IN_BASE] factor).
         */
