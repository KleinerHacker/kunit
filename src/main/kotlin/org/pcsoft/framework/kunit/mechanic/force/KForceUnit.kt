 ...
 * (`g·m·s⁻²`); that fixed factor is [org.pcsoft.framework.kunit.mechanic.force.N_IN_BASE] and is applied by the
...
enum class KForceUnit(override val symbol: String, override val baseValue: Double) : KUnit {
    ...
    companion object {
         ...
         * normalized to newtons (via the [org.pcsoft.framework.kunit.mechanic.force.N_IN_BASE] component factor).
         */
