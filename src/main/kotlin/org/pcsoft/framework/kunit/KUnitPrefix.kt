 ...
 * Example:
 * ```kotlin
 * val d = (5 kilo meters).toKUnitInstance().toKLengthUnit() // 5 km, "meters" is the KLengthUnit.METER alias
 * d.value                 // 5000.0 (normalized to meters)
 * d.valueIn(KUnitPrefix.KILO with KLengthUnit.METER) // 5.0 (read back in kilometers)
 * ```
 */
 ...
 * "pure" unit is done explicitly via the group's own conversion (e.g. `KUnitInstance.toKLengthUnit()`
 ...
 * val mixed = builder.toKUnitInstance()  // KUnitInstance: value=5000.0, units=[METER^1]
 * val length = mixed.toKLengthUnit()     // KLengthUnitInstance: value=5000.0
 * ```
 */
class KPrefixBuilder internal constructor(private val instance: KUnitInstance) {
    /**
     ...
     * `KUnitInstance.toKLengthUnit()`) to obtain the concrete "pure" unit.
     */
...
private fun buildPrefixed(value: Number, prefix: KUnitPrefix, unit: KUnit): KPrefixBuilder =
    KPrefixBuilder(KUnitInstance(value.toDouble() * prefix.factor, listOf(KUnitTerm(unit, 1))))

/**
 * Scales this number by [KUnitPrefix.QUETTA] and pairs it with [unit], e.g.
 * `(5 quetta KLengthUnit.METER).toKUnitInstance().value // 5e30`.
 */
 ...
 * `(5 ronna KLengthUnit.METER).toKUnitInstance().value // 5e27`.
 */
 ...
 * `(5 yotta KLengthUnit.METER).toKUnitInstance().value // 5e24`.
 */
 ...
 * `(5 zetta KLengthUnit.METER).toKUnitInstance().value // 5e21`.
 */
 ...
 * `(5 exa KLengthUnit.METER).toKUnitInstance().value // 5e18`.
 */
 ...
 * `(5 peta KLengthUnit.METER).toKUnitInstance().value // 5e15`.
 */
 ...
 * `(5 tera KLengthUnit.METER).toKUnitInstance().value // 5e12`.
 */
 ...
 * `(5 giga KLengthUnit.METER).toKUnitInstance().value // 5.0e9`.
 */
 ...
 * `(5 mega KLengthUnit.METER).toKUnitInstance().value // 5000000.0`.
 */
 ...
 * `(5 kilo KLengthUnit.METER).toKUnitInstance().value // 5000.0`.
 */
 ...
 * `(5 hecto KLengthUnit.METER).toKUnitInstance().value // 500.0`.
 */
 ...
 * `(5 deca KLengthUnit.METER).toKUnitInstance().value // 50.0`.
 */
 ...
 * `(5 deci KLengthUnit.METER).toKUnitInstance().value // 0.5`.
 */
 ...
 * `(5 centi KLengthUnit.METER).toKUnitInstance().value // 0.05`.
 */
 ...
 * `(5 milli KLengthUnit.METER).toKUnitInstance().value // 0.005`.
 */
 ...
 * `(5 micro KLengthUnit.METER).toKUnitInstance().value // 0.000005`.
 */
 ...
 * `(5 nano KLengthUnit.METER).toKUnitInstance().value // 5e-9`.
 */
 ...
 * `(5 pico KLengthUnit.METER).toKUnitInstance().value // 5e-12`.
 */
 ...
 * `(5 femto KLengthUnit.METER).toKUnitInstance().value // 5e-15`.
 */
 ...
 * `(5 atto KLengthUnit.METER).toKUnitInstance().value // 5e-18`.
 */
 ...
 * `(5 zepto KLengthUnit.METER).toKUnitInstance().value // 5e-21`.
 */
 ...
 * `(5 yocto KLengthUnit.METER).toKUnitInstance().value // 5e-24`.
 */
 ...
 * `(5 ronto KLengthUnit.METER).toKUnitInstance().value // 5e-27`.
 */
 ...
 * `(5 quecto KLengthUnit.METER).toKUnitInstance().value // 5e-30`.
 */
 ...
 * `KLengthUnitInstance.valueIn`, `KUnitInstance.valueAs`/`toString`), so callers can pass either a
