...
class KAccelerationUnitInstance internal constructor(internal val instance: KMixedUnitInstance) :
    ...
    override fun toString(): String = "${renderDouble(value)} ${KAccelerationUnit.BASE.symbol}"
}
...
fun KMixedUnitInstance.toAcceleration(): KAccelerationUnitInstance {
    ...
    val metersPerSecondSquared = value * lengthTerm.unit.baseValue * timeTerm.unit.baseValue.pow(-2.0)
