 ...
 * val area = (r * r) * PI     // KAreaUnitInstance: π·r² ≈ 0.04524 m²
 ...
 * a leading factor such as `PI * area` reads naturally. The result keeps the measure's dimension
 * and **its own type**.
 *
 * Example:
 * ```kotlin
 ...
 * val area = PI * (r * r)  // KAreaUnitInstance: π·r² ≈ 0.04524 m²
 * ```
 */
@Suppress("UNCHECKED_CAST")
