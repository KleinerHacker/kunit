...
class KStorageDensityUnitInstance internal constructor(internal val instance: KMixedUnitInstance) :
    ...
    override fun toString(): String = "${renderDouble(value)} ${KStorageDensityUnit.BASE.symbol}"
}
...
fun KMixedUnitInstance.toStorageDensity(): KStorageDensityUnitInstance {
    ...
    val bytesPerSquareMeter = value *
            storageTerm.unit.baseValue.pow(storageTerm.exponent.toDouble()) *
            areaTerm.unit.baseValue.pow(areaTerm.exponent.toDouble())
