...
class KTemperatureUnitInstance internal constructor(
     ...
     */
    override fun toString(): String = "${renderDouble(value)} ${KTemperatureUnit.BASE.symbol}"
}
...
fun KMixedUnitInstance.toTemperature(): KTemperatureUnitInstance {
    ...
    val kelvinValue = unit.toBase(value * unit.baseValue.pow(term.exponent.toDouble()))
