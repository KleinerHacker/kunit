...
class KForceUnitInstance internal constructor(internal val instance: KMixedUnitInstance) :
    ...
    override fun toString(): String = "${renderDouble(value / N_IN_BASE)} ${KForceUnit.BASE.symbol}"
}
...
fun KMixedUnitInstance.toForce(): KForceUnitInstance {
    ...
    val component =
        value * massTerm.unit.baseValue * lengthTerm.unit.baseValue * timeTerm.unit.baseValue.pow(-2.0)
