...
class KDensityUnitInstance internal constructor(internal val instance: KMixedUnitInstance) :
    ...
    override fun toString(): String = "${renderDouble(value / KGM3_IN_BASE)} ${KDensityUnit.BASE.symbol}"
}
...
fun KMixedUnitInstance.toDensity(): KDensityUnitInstance {
    ...
    val component = value * massTerm.unit.baseValue * lengthTerm.unit.baseValue.pow(-3.0)
