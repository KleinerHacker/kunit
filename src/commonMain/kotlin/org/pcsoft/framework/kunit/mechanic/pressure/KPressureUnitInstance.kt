...
class KPressureUnitInstance internal constructor(internal val instance: KMixedUnitInstance) :
    ...
    override fun toString(): String = "${renderDouble(value / PA_IN_BASE)} ${KPressureUnit.BASE.symbol}"
}
...
fun KMixedUnitInstance.toPressure(): KPressureUnitInstance {
    ...
    val component = value * massTerm.unit.baseValue * lengthTerm.unit.baseValue.pow(-1.0) * timeTerm.unit.baseValue.pow(-2.0)
