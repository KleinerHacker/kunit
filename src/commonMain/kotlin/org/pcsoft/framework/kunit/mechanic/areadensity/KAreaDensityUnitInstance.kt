...
class KAreaDensityUnitInstance internal constructor(internal val instance: KMixedUnitInstance) :
    ...
    override fun toString(): String = "${renderDouble(value / KGM2_IN_BASE)} ${KAreaDensityUnit.BASE.symbol}"
}
...
fun KMixedUnitInstance.toAreaDensity(): KAreaDensityUnitInstance {
    ...
    val component = value * massTerm.unit.baseValue * lengthTerm.unit.baseValue.pow(-2.0)
