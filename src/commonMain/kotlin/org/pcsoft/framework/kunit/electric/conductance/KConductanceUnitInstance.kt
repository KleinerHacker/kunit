 ...
 * ([org.pcsoft.framework.kunit.electric.resistance.KResistanceUnitInstance]): unlike a single-term wrapper it holds a
...
class KConductanceUnitInstance internal constructor(internal val instance: KMixedUnitInstance) :
    ...
    override fun toString(): String = "${renderDouble(value)} ${KConductanceUnit.BASE.symbol}"
}
...
fun KMixedUnitInstance.toConductance(): KConductanceUnitInstance {
    ...
    return conductanceInstanceOf(gramBaseProduct / SIEMENS_MASS_REFERENCE.pow(-1.0))
}
