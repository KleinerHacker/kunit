...
class KMagneticFieldStrengthUnitTest {
    ...
    fun `unit conversion`(name: String, token: KMagneticFieldStrengthUnitInstance, unit: KMagneticFieldStrengthUnit) {
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("tokenArgs")
    fun `unit symbols`(name: String, token: KMagneticFieldStrengthUnitInstance, unit: KMagneticFieldStrengthUnit) {
