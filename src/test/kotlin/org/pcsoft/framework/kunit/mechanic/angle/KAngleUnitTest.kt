...
class KAngleUnitTest {
    ...
    fun `named tokens in radians`() {
        ...
        assertEquals(Math.PI / 180.0, (1 of degrees) into radians, 1e-12)
        assertEquals(Math.PI / 10800.0, (1 of arcminutes) into radians, 1e-15)
        assertEquals(Math.PI / 648000.0, (1 of arcseconds) into radians, 1e-17)
        assertEquals(Math.PI / 200.0, (1 of gradians) into radians, 1e-12)
        assertEquals(2.0 * Math.PI, (1 of turns) into radians, 1e-12)
    }
    ...
    fun `enum entries expose symbol and factor`() {
        ...
        assertEquals(Math.PI / 180.0, KAngleUnit.DEGREE.baseValue, 1e-12)
        assertEquals(Math.PI / 10800.0, KAngleUnit.ARCMINUTE.baseValue, 1e-15)
        assertEquals(Math.PI / 648000.0, KAngleUnit.ARCSECOND.baseValue, 1e-17)
        assertEquals(Math.PI / 200.0, KAngleUnit.GRADIAN.baseValue, 1e-12)
        assertEquals(2.0 * Math.PI, KAngleUnit.TURN.baseValue, 1e-12)
    }
