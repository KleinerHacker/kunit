...
class KChemicalElementTest {
    ...
    @ParameterizedTest
    @EnumSource(KChemicalElement::class)
    fun `positional data of every element`(element: KChemicalElement) {
    ...
    @ParameterizedTest
    @EnumSource(KChemicalElement::class)
    fun `unit data of every element`(element: KChemicalElement) {
    ...
    @ParameterizedTest
    @EnumSource(KChemicalElement::class)
    fun `availability flags of every element`(element: KChemicalElement) {
    ...
    @ParameterizedTest
    @EnumSource(KChemicalElement::class)
    fun `molar volume is derived from molar mass and density`(element: KChemicalElement) {
    ...
    @ParameterizedTest
    @EnumSource(KChemicalElement::class)
    fun `every element is reachable through the lookups`(element: KChemicalElement) {
    ...
    @ParameterizedTest
    @MethodSource("identityArgs")
    fun `identity of every element`(
