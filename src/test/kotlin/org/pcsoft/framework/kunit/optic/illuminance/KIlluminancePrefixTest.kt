...
class KIlluminancePrefixTest {
    ...
    fun `si prefix on lux`(builder: KPrefixBuilder, factor: Double) {
        assertEquals(factor, (1 of builder.lux).value, rel(factor))
    }

    @ParameterizedTest
    @MethodSource("prefixArgs")
    fun `si prefix on phots`(builder: KPrefixBuilder, factor: Double) {
    ...
    @ParameterizedTest
    @MethodSource("prefixArgs")
    fun `si prefix on foot candles`(builder: KPrefixBuilder, factor: Double) {
    ...
    @ParameterizedTest
    @MethodSource("prefixArgs")
    fun `si prefix on nox`(builder: KPrefixBuilder, factor: Double) {
