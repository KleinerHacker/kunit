...
`KLatexUnitFormatter` किसी मान को **LaTeX** गणित के रूप में रेंडर करता है, जो MathJax, KaTeX या LaTeX दस्तावेज़ के लिए
तैयार होता है। डिफ़ॉल्ट कॉन्फ़िगरेशन में `3 of meters / seconds` को `km/h` में पढ़ने पर
...
लेआउट साझा नियमों का पालन करता है: `FRACTION` शैली में एक अंश और ठीक एक हर वाला स्वच्छ रूप `\frac{…}{…}` के रूप में रखा
जाता है; हर अन्य रूप — और पूरी `INLINE` शैली — गुणन चिह्न से जुड़ा एक सपाट गुणनफल होता है जिसमें चिह्नित घातांक होते
हैं। विमारहित मान केवल संख्या के रूप में रेंडर होता है।
