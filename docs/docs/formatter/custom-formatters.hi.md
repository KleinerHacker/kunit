...
[`format`](formatting.md) क्रिया और पैरामीटर-युक्त `toString` एक प्रतिस्थापन-योग्य `KUnitFormatter` के माध्यम से पाठ
प्रस्तुत करते हैं। साथ आने वाला `KDefaultUnitFormatter` `"10.8 km/h"` जैसा सादा पाठ उत्पन्न करता है, परंतु आप पूरी तरह
कस्टम प्रस्तुति जोड़ सकते हैं — उदाहरण के लिए ग्राफ़िकल सूत्र रेंडरर के लिए **LaTeX** या **MathML**, HTML, या कोई भी
डोमेन-विशिष्ट संकेतन। इससे kunit को उन तृतीय-पक्ष ढाँचों की ओर विस्तारित करना आसान हो जाता है जो किसी स्ट्रिंग को
टाइपसेट सूत्र में बदलते हैं।
...
पद का `exponent` घात बताता है (धनात्मक = अंश, ऋणात्मक = हर); घातांक को कैसे प्रस्तुत करना है यह फ़ॉर्मैटर तय करता है।
...
- `KUnitFormatContext` को लक्ष्य इकाई में **पहले से परिवर्तित** मान मिलता है, इसलिए फ़ॉर्मैटर स्वयं कोई इकाई रूपांतरण
  नहीं करता — वह केवल प्रस्तुत करता है।
