...
`KMathMlUnitFormatter` किसी मान को **प्रेज़ेंटेशन MathML** के रूप में रेंडर करता है, जिसे ब्राउज़र और MathJax मूल रूप से
रेंडर करते हैं। डिफ़ॉल्ट कॉन्फ़िगरेशन में `3 of meters / seconds` को `km/h` में पढ़ने पर `<mi>km</mi>` को
...
`MFRAC` शैली स्वच्छ एकल-हर रूप को `<mfrac>` में रखती है; हर अन्य रूप (और पूरी `EXPONENT` शैली) गुणन `<mo>` से जुड़ा सपाट
गुणनफल होता है जिसमें चिह्नित `<msup>` घातांक होते हैं। विमारहित मान केवल `<mn>` के रूप में रेंडर होता है।
