...
* **कोई ह्रासमान उपसर्ग नहीं।** एक बिट का अंश कोई सार्थक डेटा मात्रा नहीं है, इसलिए ह्रासमान SI उपसर्ग (`deci`, `centi`,
  `milli`, … — गुणक `< 1`) `bytes`/`bits` के लिए **उपलब्ध नहीं** हैं। `milli.bytes`
...
* **द्विआधारी (IEC) उपसर्ग।** दशमलव SI बिल्डरों (`kilo` = 1000) के अतिरिक्त एक दूसरा, द्विआधारी बिल्डर तंत्र है
  (`kibi` = 1024, `mebi` = 1024², …), इसलिए एक मान दशमलव चरण 1000 को द्विआधारी चरण 1024 से अलग कर सकता है।
...
`==`, `!=`, `<`, `<=`, `>`, `>=` दो `KStorageUnitInstance` मानों के प्रसामान्यीकृत `value` (बाइट) की तुलना करते हैं।
`equals` प्रसामान्यीकृत मात्रा से होता है, इसलिए `(1 of bytes) == (8 of bits)`।

## `pow` से घात

infix `pow` संकारक से किसी मान को एक पूर्णांक घात तक उठाएँ (Kotlin में कोई अतिभारयोग्य `^` नहीं)। भंडारण समूह के लिए
`pow` एक सामान्य `KMixedUnitInstance` लौटाता है (भंडारण के पास कोई विमायुक्त घात प्रकार नहीं):
...
`giga`, `tera`, `peta`, `exa`, `zetta`, `yotta`, `ronna`, `quetta`) के साथ गुण पहुँच के माध्यम से जोड़ा जा सकता है।
ह्रासमान बिल्डरों (`deci` से नीचे) में **कोई** `bytes`/`bits` गुण नहीं है, इसलिए `milli.bytes`
संकलित नहीं होता।
...
किसी समय के साथ संयोजित एक भंडारण मान एक डेटा दर (`byte·second⁻¹`) बनाता है, और वापस अपघटित किया जा सकता है:
