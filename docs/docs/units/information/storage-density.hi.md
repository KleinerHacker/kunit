...
`+1` वाला एक `KStorageUnit.BASE` (बाइट) और घातांक `-2` वाला एक `KDistanceUnit.BASE` (मीटर)। मान हमेशा बाइट प्रति वर्ग
मीटर में सामान्यीकृत होकर संग्रहीत रहता है, चाहे इसे किसी भी इकाई या भंडारण/क्षेत्रफल संयोजन से बनाया गया हो।
...
SI/द्विआधारी उपसर्ग और लंबाई इकाइयाँ स्वतंत्र रूप से जुड़ती हैं। इसे किसी भी भंडारण-प्रति-क्षेत्रफल टेम्पलेट में वापस
पढ़ें (`d into (bits / area)`)। जानबूझकर कोई वर्तनी-सहित संयुक्त टोकन **नहीं** है।
...
एक फ़्लैश डाई **100 mm²** के तल पर **256 GB** संग्रहीत करती है। इसका क्षेत्रीय भंडारण घनत्व डेटा की मात्रा को क्षेत्रफल
से विभाजित करने पर मिलता है:
...
भंडारण घनत्व *ही* भंडारण मात्रा को क्षेत्रफल से विभाजित करना है। तीन राशियों — भंडारण, क्षेत्रफल और भंडारण घनत्व — के
बीच सामान्य `*` और `/` से आवागमन करें; प्रत्येक परिणाम **दृढ़-प्रकार** है।
...
`KMixedUnitInstance.toStorageDensity()` के लिए घातांक `+1` वाला ठीक एक भंडारण पद और घातांक `-2` वाला ठीक एक दूरी पद
आवश्यक है। `B²·m⁻²`, `B·m⁻¹`, या `B·m²` आकार भंडारण घनत्व नहीं है — रूपांतरण
...
अंश **वर्धक** SI बिल्डर (`kilo`, `mega`, …) या **द्विआधारी** बिल्डर (`kibi`, `mebi`, …) का उपयोग करता है; हर (क्षेत्रफल)
किसी भी लंबाई इकाई और उपसर्ग का उपयोग करता है।
...
नीचे दी गई तालिका दिखाती है कि यह इकाई और इसके घटक गणितीय रूप से बनाम KUnit के साथ Kotlin में कैसे लिखे जाते हैं। घातांक
यूनिकोड सुपरस्क्रिप्ट (`²`, `³`, `⁻¹`) का उपयोग करते हैं, `·` गुणन को और `/` भिन्न को दर्शाता है। जहाँ किसी राशि को
भिन्न रूप में और ऋणात्मक घातांक वाले गुणनफल रूप में—दोनों तरह से लिखा जा सकता है, वहाँ दोनों समतुल्य Kotlin रूप सूचीबद्ध
हैं।
