...
पदार्थ की मात्रा सात SI मूल राशियों में से एक है — सीधे मापने योग्य, गैर-संघटित राशि, इसलिए यह एक **नेटिव इकाई** है।
`KAmountOfSubstanceUnitInstance` सरल, एक-आयामी रैपर रूप है: घातांक 1 पर एक ही
...
यह समूह अवोगाद्रो स्थिरांक का सटीक SI मान `AVOGADRO_CONSTANT` के रूप में (6.02214076e23 mol⁻¹) और किसी इंस्टेंस पर
सुविधाजनक `particleCount()` उजागर करता है। दोनों एक सादा
...
सोडियम क्लोराइड (मोलर द्रव्यमान 58.44 g/mol) के 25 g टेबल सॉल्ट में कितने मोल हैं, और वह कितनी सूत्र इकाइयों के बराबर
है?
...
पदार्थ की मात्रा को किसी अन्य राशि से गुणा या भाग करने पर यह जेनेरिक मिश्रित-इकाई इंजन में बाहर निकल जाती है, जब तक कोई
टाइप किया गया परिणाम मौजूद न हो — जैसे `energy / amountOfSubstance` एक टाइप की गई
...
नीचे दी गई तालिका दिखाती है कि यह इकाई गणितीय रूप से कैसे लिखी जाती है बनाम KUnit के साथ Kotlin में कैसे। घातांक यूनिकोड
