...
(`K/m`)। यह चालन (conduction) की प्रेरक राशि है — किसी [तापीय चालकता](thermal-conductivity.md) से
गुणा करने पर यह [ऊष्मा फ्लक्स घनत्व](heat-flux-density.md) देती है।
...
!!! note "प्रवणता प्रति लंबाई एक *परिवर्तन* है"
    ...
    का किसी प्रवणता में कोई अर्थ नहीं है — केवल अंतराल का अर्थ है। यही कारण है कि `°F/ft` फारेनहाइट
    *अंतराल* गुणांक 5/9 से परिवर्तित होता है, −32 ऑफसेट से नहीं।
...
पृथ्वी की परत गहराई के प्रति किलोमीटर लगभग 25 K गर्म होती है। एक बोरहोल 3.5 km तक पहुँचता है। तली में
चट्टान कितनी अधिक गर्म है, और 100 K वृद्धि के लिए कितनी गहराई ड्रिल करनी होगी?
