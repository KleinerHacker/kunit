...
القدرة من الناحية التقنية كمّية **واحدة** تظهر في عدة مجالات موضوعية. تصف هذه الصفحة قراءتها *الديناميكية الحرارية* —
**معدّل التدفق الحراري** `Φ = Q / t`، أي طاقة حرارية لكل زمن. المجموعة نفسها في Kotlin موثّقة للمجالات الأخرى
في [القدرة (كهربائية)](../electrical/power.md) و
[القدرة (ميكانيكا)](../mechanics/power.md).

وضمن الديناميكا الحرارية يحمل النوع نفسه أيضًا قراءة **تدفّق الحرارة** — انظر
[تدفّق الحرارة](heat-flow.md) لهذا المنظور وللسلسلة الممتدّة إلى
[كثافة التدفّق الحراري](heat-flux-density.md).
