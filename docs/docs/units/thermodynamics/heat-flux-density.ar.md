...
كثافة التدفّق الحراري هي تدفّق الحرارة لكل وحدة مساحة: `power / area` (`W/m²`). وتقيس نفس الوحدة
*الإشعاع الوارد* و*الإصدار الإشعاعي* — شدّة الإشعاع الساقط على سطح أو الصادر عنه.
...
يستقبل سطح المنزل 800 W/m² في يوم صافٍ. تغطّي المصفوفة 25 m² وتحوّل 20 % من الإشعاع الساقط. ما القدرة
الكهربائية التي تسلّمها؟
