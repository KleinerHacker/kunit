...
Molar energy is energy per amount of substance: `energy / amountOfSubstance` (`J/mol`). Depending on context the same
quantity is called *molar enthalpy*, *reaction enthalpy* or *bond energy*.
...
Per unit of temperature this becomes [molar heat capacity](molar-heat-capacity.md); per kilogram instead of per mole it
becomes [specific energy](specific-energy.md).
...
The electronvolt-per-entity token converts a *per-particle* energy into a *per-mole* energy — its factor is the Faraday
constant. All units accept the full SI prefix range (`kilo.joulesPerMole`,
...
The enthalpy of formation of liquid water is −286 kJ/mol. How much energy is released when 4 moles of hydrogen burn, and
what is that per molecule?
