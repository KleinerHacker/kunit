...
विशिष्ट ऊर्जा प्रति इकाई द्रव्यमान ऊर्जा है: `energy / mass` (`J/kg`)। संदर्भ के आधार पर इसी राशि को *विशिष्ट
एन्थैल्पी*, *विशिष्ट गुप्त ऊष्मा* या *कैलोरी मान* कहा जाता है — ये सभी इसी इकाई समूह को साझा करते हैं।
...
`J/kg = kg·m²·s⁻²/kg = m²·s⁻²`। इसलिए विहित सामान्य रूप में द्रव्यमान का कोई पद नहीं है। केवल `KMassUnitInstance` के
विरुद्ध संकारक ही द्रव्यमान समूह के ग्राम आधार को इस समूह की प्रति-किलोग्राम परिभाषा से जोड़ते हैं।

प्रति इकाई तापमान यह [विशिष्ट ऊष्मा क्षमता](specific-heat-capacity.md) बन जाती है; प्रति किलोग्राम के बजाय प्रति मोल
यह [मोलर ऊर्जा](molar-energy.md) बन जाती है।
