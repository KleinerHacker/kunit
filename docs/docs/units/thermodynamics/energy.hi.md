...
ऊर्जा तकनीकी रूप से **एक** राशि है जो कई विषय‑क्षेत्रों में प्रकट होती है। यह पृष्ठ इसके *ऊष्मागतिकीय* पठन — **ऊष्मा**,
`Q = Φ · t` — का वर्णन करता है। वही Kotlin समूह अन्य क्षेत्रों के लिए
[ऊर्जा (विद्युत)](../electrical/energy.md) और [ऊर्जा (यांत्रिकी)](../mechanics/energy.md) में प्रलेखित है।

किसी तापमान अंतर से विभाजित करने पर ऊर्जा [ऊष्मा क्षमता](heat-capacity.md) बन जाती है (या,
`ΔS = Q / T` के रूप में पढ़ने पर, [एन्ट्रॉपी](entropy.md)); प्रति किलोग्राम यह
[विशिष्ट ऊर्जा](specific-energy.md) बन जाती है, प्रति मोल [मोलर ऊर्जा](molar-energy.md)।

## ऊर्जा बनाना

ऊर्जा को नामित टोकन से या किसी अपघटन (नीचे देखें) से बनाया जाता है। नामित इकाइयाँ मान‑1 टोकन के रूप में उपलब्ध रहती हैं
(`of`/`into` के साथ प्रयोग)। समूह की ऊष्मीय इकाइयाँ कैलोरी और ब्रिटिश थर्मल यूनिट हैं:
...
नामित इकाइयाँ `KPrefixBuilder` के माध्यम से SI उपसर्गों का समर्थन करती हैं (`kilo.calories` — "फूड कैलोरी" —
