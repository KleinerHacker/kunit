...
القدرة من الناحية التقنية كمّية **واحدة** تظهر في عدة مجالات موضوعية. تصف هذه الصفحة قراءتها *الكهربائية* (`P = U · I`).
المجموعة نفسها في Kotlin موثّقة للمجالات الأخرى في
...
* **القدرة التفاعلية** `Q = U · I · sin φ` بالفولت أمبير التفاعلي (`var`) — الجزء المتذبذب بين المصدر والحمل دون بذل
  شغل.

ولأن الثلاثة تختلف بالاصطلاح فقط، تحتفظ KUnit بها في هذه المجموعة الواحدة وتفصلها بالرمز:
`1 VA = 1 var = 1 W`. تعمل البادئات كالمعتاد، فـ `kilo.voltAmperes` تساوي 1 kVA و`kilo.vars` تساوي 1 kvar.
