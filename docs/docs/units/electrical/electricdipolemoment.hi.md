...
(मीटर) को `+1` पर। इस समूह में द्रव्यमान विमा नहीं है, अतः ग्राम/किलोग्राम पुल की आवश्यकता नहीं है; संग्रहीत मान हमेशा
कूलॉम मीटर में सामान्यीकृत रहता है।

विद्युत द्विध्रुव आघूर्ण `p = Q · d` एक धनात्मक और ऋणात्मक [आवेश](charge.md) के बीच के पृथक्करण को मापता है। यह वह राशि
है जो किसी अणु को [विद्युत क्षेत्र सामर्थ्य](electricfieldstrength.md) से जोड़ती है।

## विद्युत द्विध्रुव आघूर्ण का निर्माण

द्विध्रुव आघूर्ण को नामित टोकन से, या किसी अपघटन (नीचे देखें) से बनाया जा सकता है। नामित इकाइयाँ मान-1 टोकन के रूप में
उपलब्ध रहती हैं (`of`/`into` के साथ प्रयुक्त):
...
डिबाई अणु भौतिकी और रसायन विज्ञान में प्रमुख है। नामित इकाइयाँ `KPrefixBuilder` के माध्यम से SI उपसर्गों का समर्थन करती
हैं (`pico.coulombMeters`, `milli.debyes`, …)।
...
विद्युत द्विध्रुव आघूर्ण तक कई **समतुल्य अपघटनों** से पहुँचा जा सकता है, जो सभी मान-समान आघूर्ण उत्पन्न करते हैं:
...
`KMixedUnitInstance` ही रहता है और `toElectricDipoleMoment()` (जो केवल विहित सामान्य रूप को पहचानता है, अन्यथा
`IllegalStateException` फेंकता है) से संकुचित किया जाता है। दोनों मार्ग मान-समान हैं।
...
घातांक यूनिकोड सुपरस्क्रिप्ट का उपयोग करते हैं, `·` गुणन और `/` भिन्न दर्शाता है। जहाँ किसी राशि को भिन्न और ऋणात्मक
घातांक वाले गुणनफल दोनों रूपों में लिखा जा सकता है, वहाँ दोनों समतुल्य Kotlin रूप सूचीबद्ध हैं।
