...
(`kg·m·s⁻²·A⁻²` = `H/m`)। `KPermeabilityUnitInstance` चार पदों वाले `KMixedUnitInstance` को लपेटता है — घातांक `+1` पर
`KMassUnit.BASE` (ग्राम), घातांक `+1` पर `KDistanceUnit.BASE` (मीटर), घातांक `-2` पर
`KTimeUnit.BASE` (सेकंड) और घातांक `-2` पर `KElectricCurrentUnit.BASE` (ऐम्पियर)। चूँकि लाइब्रेरी का द्रव्यमान घटक
**ग्राम** में सामान्यीकृत है (किलोग्राम में नहीं), विहित गुणनफल को हेनरी प्रति मीटर तक पहुँचने के लिए 1000 से विभाजित
किया जाता है; संग्रहीत मान हमेशा हेनरी प्रति मीटर में सामान्यीकृत रहता है।
...
पारगम्यता को नामित टोकन से या किसी अपघटन (नीचे देखें) से बनाया जाता है। नामित इकाइयाँ मान‑1 टोकन के रूप में उपलब्ध रहती
...
टाइप किए गए ऑपरेटर रूप सीधे पारगम्यता लौटाते हैं। पूर्णतः मूल व्यंजक सामान्य `KMixedUnitInstance` ही रहता है और
`toPermeability()` से संकुचित किया जाता है (जो केवल विहित रूप को पहचानता है, अन्यथा
