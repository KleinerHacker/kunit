...
धारा घनत्व एक **संरचित** इकाई है: संयोजन `current · length⁻²` (`A/m²`) — चालक अनुप्रस्थ‑काट प्रति विद्युत धारा।
`KCurrentDensityUnitInstance` दो पदों वाले `KMixedUnitInstance` को लपेटता है — घातांक `+1` पर
`KElectricCurrentUnit.BASE` (ऐम्पियर) और घातांक `-2` पर `KDistanceUnit.BASE` (मीटर)। दोनों घटक अपने समूह आधार इकाइयों
में संग्रहीत रहते हैं, इसलिए मान सीधे A/m² में पठन है।

## धारा घनत्व बनाना

धारा घनत्व में **कोई नामित टोकन नहीं** और अपने स्वयं के कोई उपसर्ग बिल्डर नहीं हैं: हर वर्तनी एक अनुपात है (`A/m²`,
`A/mm²`, …)। इसे व्यंजक के रूप में या टाइप किए गए `current / area` ऑपरेटर से बनाएँ, और इसे ऐसे व्यंजक के विरुद्ध `into`
से वापस पढ़ें:
...
टाइप किया गया ऑपरेटर रूप सीधे धारा घनत्व लौटाता है। पूर्णतः मूल व्यंजक सामान्य `KMixedUnitInstance` ही रहता है और
`toCurrentDensity()` से संकुचित किया जाता है (जो केवल विहित रूप को पहचानता है, अन्यथा
