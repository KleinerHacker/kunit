...
(متر) بالأس `-1`. لا تحمل هذه المجموعة أي بُعد كتلة، لذا لا حاجة إلى جسر غرام/كيلوغرام؛ وتُطبَّع القيمة المخزّنة دائمًا
إلى كولوم لكل متر.

كثافة الشحنة الخطية `λ` هي الشحنة المحمولة لكل وحدة طول، مثلًا على طول سلك أو خيط مشحون. **لا توجد لها وحدة مسمّاة خاصة
بها**: فكل صياغة هي نسبة (C/m، µC/cm)، ولذلك لا تملك المجموعة رموزًا مجرّدة ولا بناة بادئات — تُبنى القيم من تعبير أو
عبر العمليات المصرَّحة الأنواع. النظيران ثنائي وثلاثي الأبعاد هما
...
يونيكود العلوية (`⁻¹`)، ويرمز `·` للضرب و `/` للكسر. وحيثما أمكن كتابة الكمية ككسر وكحاصل ضرب بأسس سالبة، تُذكر الصيغتان
المتكافئتان في Kotlin.
