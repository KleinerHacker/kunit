...
पैकेज: `org.pcsoft.framework.kunit.electric.capacitance`
...
पर `KElectricCurrentUnit.BASE` (एम्पियर)। चूँकि लाइब्रेरी का द्रव्यमान घटक **ग्राम** (किलोग्राम नहीं) पर सामान्यीकृत है
और द्रव्यमान का घातांक *ऋणात्मक* है, इसलिए फैरड कच्चे घटक आधार से विपरीत दिशा में 1000 गुना है; संग्रहीत मान फैरड में
सामान्यीकृत रहता है।

## धारिता बनाना

धारिता को नामित टोकन से बनाएँ, या किसी अपघटन से (नीचे देखें)। नामित इकाइयाँ मान-1 टोकन के रूप में रहती हैं (`of`/`into`
के साथ प्रयोग):
...
नीचे दी गई तालिका दिखाती है कि यह इकाई और इसके घटक गणितीय रूप में तथा KUnit के साथ Kotlin में कैसे लिखे जाते हैं। घातांक
यूनिकोड सुपरस्क्रिप्ट (`²`, `⁴`, `⁻¹`) से लिखे जाते हैं, `·` गुणा और `/` भिन्न दर्शाता है। जहाँ किसी राशि को भिन्न तथा
