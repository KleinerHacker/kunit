...
ऊर्जा एक **संरचित** इकाई है: संयोजन `mass · length² · time⁻²` (`kg·m²·s⁻²`)। `KEnergyUnitInstance` तीन पदों वाले
`KMixedUnitInstance` को लपेटता है — घातांक `+1` पर `KMassUnit.BASE` (ग्राम), घातांक `+2` पर
`KDistanceUnit.BASE` (मीटर) और घातांक `-2` पर `KTimeUnit.BASE` (सेकंड)। चूँकि लाइब्रेरी का द्रव्यमान घटक **ग्राम** में
सामान्यीकृत है (किलोग्राम में नहीं), जूल तक पहुँचने के लिए विहित गुणनफल को 1000 से विभाजित किया जाता है; संग्रहीत मान
हमेशा जूल में सामान्यीकृत रहता है।

ऊर्जा तकनीकी रूप से **एक** राशि है जो कई विषय‑क्षेत्रों में प्रकट होती है। यह पृष्ठ इसके *विद्युत* पठन (`W = Q · U`, और
उपभुक्त विद्युत ऊर्जा के लिए `W = P · t`) का वर्णन करता है। वही Kotlin समूह अन्य क्षेत्रों के
लिए [ऊर्जा (यांत्रिकी)](../mechanics/energy.md) और [ऊर्जा (ऊष्मागतिकी)](../thermodynamics/energy.md) में प्रलेखित है।

## ऊर्जा बनाना

ऊर्जा को नामित टोकन से या किसी अपघटन (नीचे देखें) से बनाया जाता है। नामित इकाइयाँ मान‑1 टोकन के रूप में उपलब्ध रहती हैं
...
|----------------------|-----------------------|------------------------------------------------------------|
| `charge * voltage`   | `KEnergyUnitInstance` | विद्युत ऊर्जा `W = Q · U` (क्रमविनिमेय)                                |
| `power * time`       | `KEnergyUnitInstance` | उपभुक्त ऊर्जा `W = P · t` (क्रमविनिमेय)                               |
...
टाइप किए गए ऑपरेटर रूप सीधे ऊर्जा लौटाते हैं। पूर्णतः मूल व्यंजक सामान्य `KMixedUnitInstance` ही रहता है और `toEnergy()`
से संकुचित किया जाता है (जो केवल विहित रूप को पहचानता है, अन्यथा `IllegalStateException`
फेंकता है)। सभी मार्ग मान‑समान हैं।

व्युत्क्रम ऑपरेटर आवेश, वोल्टता, शक्ति, समय और ऊर्जा को जोड़ते हैं:
...
(1 of kilo.joules).toString()     // "1000.0 J" (आधार इकाई)
```
...
| गणित         | Kotlin                                            | अर्थ                                 |
|-------------|---------------------------------------------------|------------------------------------|
| `J`         | `joules`                                          | ऊर्जा, आधार इकाई (नामित टोकन, जूल)          |
| `Q · U`     | `(10 of coulombs) * (50 of volts)`                | आवेश और वोल्टता से विद्युत ऊर्जा                |
| `P · t`     | `(2 of kilo.watts) * (3 of hours)`                | उपभुक्त ऊर्जा (kWh का कोई टोकन नहीं है)        |
