...
पैकेज: `org.pcsoft.framework.kunit.electric.conductivity`
...
**ग्राम** में सामान्यीकृत है (किलोग्राम में नहीं) और द्रव्यमान घातांक *ऋणात्मक* है, विहित गुणनफल को सीमेंस प्रति मीटर तक
पहुँचने के लिए 1000 से गुणा किया जाता है; संग्रहीत मान हमेशा S/m में सामान्यीकृत रहता है।

चालकता चालन के पीछे की पदार्थ गुण है और [प्रतिरोधकता](resistivity.md) की व्युत्क्रम (`σ = 1 / ρ`) है।

## चालकता बनाना

चालकता को नामित टोकन से या किसी अपघटन (नीचे देखें) से बनाया जाता है। नामित इकाइयाँ मान‑1 टोकन के रूप में उपलब्ध रहती हैं
...
टाइप किए गए ऑपरेटर रूप सीधे चालकता लौटाते हैं। पूर्णतः मूल व्यंजक सामान्य `KMixedUnitInstance` ही रहता है और
`toConductivity()` से संकुचित किया जाता है (जो केवल विहित रूप को पहचानता है, अन्यथा
