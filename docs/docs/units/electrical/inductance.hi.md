...
प्रसामान्यीकृत है, हेनरी कच्चे घटक आधार का 1000× है; संग्रहित मान हेनरी में प्रसामान्यीकृत है।

## एक प्रेरकत्व बनाना

प्रेरकत्व को किसी नामित टोकन से, या किसी अपघटन से बनाएँ (नीचे देखें)। नामित इकाइयाँ मान-1 टोकन के रूप में बचती हैं
...
प्रेरकत्व तक कई **समतुल्य अपघटनों** के माध्यम से पहुँचा जा सकता है, सभी समान मान-तुल्य प्रेरकत्व उत्पन्न करते हैं:
...
किसी चुंबकीय परिपथ का **पर्मिएंस** `Λ` उसकी [चुंबकीय अनिच्छा (reluctance)](reluctance.md) का व्युत्क्रम है,
`Λ = 1 / Rm`। यह प्रेरकत्व के **विमीय रूप से समान** है और हेनरी में ही मापा जाता है, इसलिए KUnit इसे इसी समूह और प्रतीक
`H` से मॉडल करता है; कोई अलग टोकन और कोई अलग प्रकार नहीं है। व्युत्क्रम संकारक दोनों समूहों को एक साथ बाँधते हैं:
...
घातांक यूनिकोड सुपरस्क्रिप्ट (`²`, `³`, `⁻¹`) से लिखे जाते हैं, `·` गुणन और `/` भिन्न को दर्शाता है। जहाँ किसी राशि को
