...
Energy is technically **one** quantity that appears in several subject areas. This page describes its *electrical*
reading (`W = Q · U`, and `W = P · t` for consumed electrical energy). The same Kotlin group is documented for the other
areas in [Energy (Mechanics)](../mechanics/energy.md) and
