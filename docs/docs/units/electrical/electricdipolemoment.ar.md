...
الحزمة: `org.pcsoft.framework.kunit.electric.electricdipolemoment`
...
العزم ثنائي القطب الكهربائي `p = Q · d` يقيس الفصل بين [شحنة](charge.ar.md) موجبة وأخرى سالبة. وهي الكمية التي تربط
الجزيء بـ[شدة المجال الكهربائي](electricfieldstrength.ar.md).
