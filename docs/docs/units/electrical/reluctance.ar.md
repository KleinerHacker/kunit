...
كيلوغرامات) وأس الكتلة *سالب*، يُضرَب الناتج القياسي في 1000 للوصول إلى أمبير لكل ويبر؛ وتُطبَّع القيمة المخزّنة دائمًا
إلى أمبير لكل ويبر.

الممانعة `Rm` هي نظير الدارة المغناطيسية لـ[المقاومة](resistance.ar.md) الكهربائية: تربط القوة الدافعة المغناطيسية `Θ`
(تُقاس بلفّات الأمبير، انظر [التيار الكهربائي](ec.ar.md)) بـ
[التدفق المغناطيسي](magneticflux.ar.md) الناتج عبر قانون هوبكنسون `Θ = Rm · Φ`. ومقلوبها هو **النفاذية المغناطيسية (
Permeance)** `Λ`، التي تُقاس بالهنري، ولذلك تحملها مجموعة
...
تصف الصياغات الثلاث الكمية نفسها — لأن عدد لفّات الملف عدد صِرف — ولذلك فهي متساوية القيمة؛ وتوثّق الرموز المختلفة وجهة
النظر. تدعم الوحدات المسمّاة بادئات النظام الدولي عبر `KPrefixBuilder`
