...
الحزمة: `org.pcsoft.framework.kunit.resistivity`
...
بالأس `-3`، و`KElectricCurrentUnit.BASE` (أمبير) بالأس `-2`. ولأن مكوّن الكتلة في المكتبة مطبَّع إلى
**غرامات** (وليس كيلوغرامات)، يُقسَم الناتج القياسي على 1000 للوصول إلى الأوم متر؛ وتُطبَّع القيمة
المخزّنة دائمًا إلى الأوم متر.
