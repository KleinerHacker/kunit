...
`KElectricCurrentUnit.BASE` (ऐम्पियर) और घातांक `-1` पर `KDistanceUnit.BASE` (मीटर)। संग्रहीत मान सदैव ऐम्पियर प्रति
मीटर में सामान्यीकृत रहता है।

संबंधित पृष्ठ: [विद्युत धारा](ec.md) और [दूरी](../kinematics/distance.md) इस इकाई के दो घटक समूह हैं।

## चुंबकीय क्षेत्र तीव्रता बनाना

क्षेत्र तीव्रता किसी नामित टोकन से, या किसी अपघटन से (नीचे देखें) बनाई जाती है। नामित इकाइयाँ मान‑1 टोकन के रूप में
...
टाइप‑युक्त संकारक रूप सीधे क्षेत्र तीव्रता लौटाता है। पूर्णतः मूल व्यंजक सामान्य `KMixedUnitInstance` ही रहता है और
`toMagneticFieldStrength()` से संकुचित किया जाता है (जो केवल विहित सामान्य रूप पहचानता है, अन्यथा
...
नीचे दी गई तालिका दर्शाती है कि यह इकाई और इसके घटक गणितीय रूप में कैसे लिखे जाते हैं बनाम KUnit के साथ Kotlin में कैसे।
