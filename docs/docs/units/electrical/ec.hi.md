...
विद्युत धारा समूह एक विद्युत धारा को मॉडल करता है। यह एक **सादा, एक-विमीय** नेटिव समूह है (कोई घातांक-विशेषीकृत उपप्रकार
नहीं, कोई पार-इकाई प्रकार-युक्त परिणाम नहीं): `KElectricCurrentUnitInstance`
एक एकल `KElectricCurrentUnit.AMPERE` पद को लपेटता है, सदैव ऐम्पियर में प्रसामान्यीकृत।

SI ऐम्पियर के अतिरिक्त, समूह दो शास्त्रीय CGS धारा इकाइयाँ प्रदान करता है: विद्युतचुंबकीय प्रणाली का **बायो**
(ऐब-ऐम्पियर) (`1 Bi = 10 A`) और विद्युतस्थैतिक प्रणाली का **स्टैट-ऐम्पियर**
...
प्रत्येक `Token` एक मान-1 `KElectricCurrentUnitInstance` है जो `of` (निर्माण) और `into` (पठन) के साथ प्रयुक्त होता है।

### चुंबकत्वचालक बल (ऐम्पियर टर्न)

**चुंबकत्वचालक बल** `Θ = N · I` — किसी चुंबकीय परिपथ का चालन — विमीय रूप से विद्युत धारा के समान है, क्योंकि फेरों की
संख्या `N` एक शुद्ध गणना है। इसलिए इसका अपना कोई समूह नहीं है: यह इसी समूह के भीतर ऐम्पियर टर्न (`At`) का उपयोग करता है।
अलग प्रतीक यह दस्तावेज़ित करता है कि मान एक तार की एकल धारा के बजाय किसी कुंडली के कुल चालन को वर्णित करता है।
`1 At = 1 A`, और उपसर्ग सामान्य रूप से कार्य करते हैं (`kilo.ampereTurns`)।
...
ओम का नियम: `U = 5 V` पर `R = 220 Ω` का एक प्रतिरोधक एक धारा `I = U / R` वहन करता है। धारा इकाई के माध्यम से व्यक्त:
...
infix `pow` संकारक से किसी मान को एक पूर्णांक घात तक उठाएँ (Kotlin में कोई अतिभारयोग्य `^` नहीं)। विद्युत धारा समूह के
लिए `pow` एक सामान्य `KMixedUnitInstance` लौटाता है (धारा के पास कोई विमायुक्त घात प्रकार नहीं):
...
विद्युत धारा **कोई भी** परिमाण स्वीकारती है, इसलिए हर SI उपसर्ग बिल्डर (`quetta` … `quecto`) को हर धारा इकाई के साथ गुण
पहुँच के माध्यम से जोड़ा जा सकता है। मिलीऐम्पियर `milli.amperes` है, किलोऐम्पियर
`kilo.amperes` है।
...
घातांक Unicode उपरिलेख (`²`, `³`, `⁻¹`) से लिखे जाते हैं, `·` गुणन और `/` भिन्न दर्शाता है।
