...
(`kg⁻¹·m⁻²·s³·A²`)। `KConductanceUnitInstance` चार पदों वाले `KMixedUnitInstance` को लपेटता है —
घातांक `-1` पर `KMassUnit.BASE` (ग्राम), घातांक `-2` पर `KDistanceUnit.BASE` (मीटर), घातांक `+3` पर
`KTimeUnit.BASE` (सेकंड) और घातांक `+2` पर `KElectricCurrentUnit.BASE` (एम्पियर)। चूँकि लाइब्रेरी का
द्रव्यमान घटक **ग्राम** (किलोग्राम नहीं) में सामान्यीकृत है और द्रव्यमान का घातांक ऋणात्मक है, इसलिए
सीमेंस कच्चे घटक आधार का 1/1000 गुना है; संग्रहीत मान सीमेंस में सामान्यीकृत होता है।
...
चालकता को नामित टोकन से, या किसी अपघटन से (नीचे देखें) बनाएँ। नामित इकाइयाँ मान-1 टोकन के रूप में बनी
रहती हैं (`of`/`into` के साथ प्रयुक्त):
...
प्रकार-युक्त ऑपरेटर रूप सीधे चालकता लौटाते हैं। पूर्णतः मूल व्यंजक सामान्य `KMixedUnitInstance` ही रहता है
और उसे `toConductance()` से संकुचित किया जाता है (जो केवल विहित रूप पहचानता है, अन्यथा
...
नीचे दी गई तालिका दर्शाती है कि इस इकाई और इसके घटकों को गणितीय रूप में कैसे लिखा जाता है, और KUnit के साथ Kotlin में कैसे। घातांक यूनिकोड सुपरस्क्रिप्ट (`²`, `³`, `⁻¹`) से लिखे जाते हैं, `·` गुणा और `/` भिन्न दर्शाता है। जहाँ किसी राशि को भिन्न रूप में और ऋणात्मक घातांकों वाले गुणनफल के रूप में, दोनों तरह से लिखा जा सकता है, वहाँ दोनों समतुल्य Kotlin रूप सूचीबद्ध हैं।
