...
(`A·s·m⁻²` = `C/m²`)। `KElectricFluxDensityUnitInstance` तीन पदों वाले `KMixedUnitInstance` को लपेटता है — घातांक `+1`
पर `KElectricCurrentUnit.BASE` (ऐम्पियर), घातांक `+1` पर `KTimeUnit.BASE` (सेकंड) और घातांक
`-2` पर `KDistanceUnit.BASE` (मीटर)। समूह में कोई द्रव्यमान आयाम नहीं है, इसलिए ग्राम/किलोग्राम सेतु की आवश्यकता नहीं
है; संग्रहीत मान हमेशा कूलम्ब प्रति वर्ग मीटर में सामान्यीकृत रहता है।
...
[विद्युत क्षेत्र तीव्रता](electricfieldstrength.md) से [विद्युतशीलता](permittivity.md) के माध्यम से जुड़ा है
(`D = ε · E`)। इसका एक-आयामी समकक्ष [रैखिक आवेश घनत्व](linearchargedensity.md) है, त्रि-आयामी समकक्ष
[आवेश घनत्व](chargedensity.md) है।

## विद्युत फ्लक्स घनत्व बनाना

फ्लक्स घनत्व को नामित टोकन से या किसी अपघटन (नीचे देखें) से बनाया जाता है। नामित इकाइयाँ मान‑1 टोकन के रूप में उपलब्ध
...
टाइप किए गए ऑपरेटर रूप सीधे फ्लक्स घनत्व लौटाते हैं। पूर्णतः मूल व्यंजक सामान्य `KMixedUnitInstance` ही रहता है और
`toElectricFluxDensity()` से संकुचित किया जाता है (जो केवल विहित रूप को पहचानता है, अन्यथा
