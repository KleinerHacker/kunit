...
पैकेज: `org.pcsoft.framework.kunit.kinematic.distance`, `…time`, `…speed`, `…acceleration`,
`…frequency`, `…volumeflow`

शुद्धगतिकी **गति** का वर्णन है — कितनी दूर, कितनी देर, कितनी तेज़, और गति की दर स्वयं कैसे बदलती है — इसके पीछे के बलों
को अभी पूछे बिना (वह [यांत्रिकी](../mechanics/overview.md) का विषय है)। KUnit इस क्षेत्र को 2 **नेटिव** मूल राशियों और
उनसे **निर्मित** 3 राशियों से मॉडल करता है, जिससे शास्त्रीय गति सूत्र प्रबल-प्रकार बने रहते हुए सामान्य `*` और `/`
व्यंजक बन जाते हैं।
...
| आयतन प्रवाह | निर्मित | घन मीटर प्रति सेकंड (`m³/s`) | [आयतन प्रवाह](volume-flow.md) |

## राशियाँ कैसे संबंधित हैं

चाल दूरी बटा समय है, त्वरण चाल बटा समय है, और आवृत्ति समय का व्युत्क्रम है। KUnit प्रत्येक संयोजन के लिए सही
**प्रकार-युक्त** राशि लौटाता है — आपको कभी कच्ची मिश्रित इकाई हाथ से बनानी नहीं पड़ती:
...
एक कार **1.5 h** में **120 km** तय करती है। इसकी औसत चाल `v = s / t` है, और इस चाल को अवधि से गुणा करने पर पुनः तय की गई
दूरी मिलती है:
...
नीचे दी गई तालिका इस क्षेत्र के मूल संबंधों को गणितीय बनाम KUnit के Kotlin संकेतन में दर्शाती है। घातांक Unicode उपरिलेख
...
| `q̇ = V / t`  | `(600 of liters) / (2 of minutes)`                   | आयतन ÷ समय से आयतन प्रवाह   |
| `V = q̇ · t`  | `q * (15 of minutes)`                                | प्रवाह दर × समय से आयतन     |
...
* [आयतन प्रवाह](volume-flow.md) — आयतन प्रति समय, `m³/s`, `l/min` और `gpm`।
