...
الحزمة: `org.pcsoft.framework.kunit.kinematic.speed`
...
`KDistanceUnit.BASE` (متر) عند أُسّ `+1` و`KTimeUnit.BASE` (ثانية) عند أُسّ `-1`. تُخزَّن القيمة دائمًا مُطبَّعة إلى
المتر لكل ثانية، بصرف النظر عن الوحدة أو تركيبة الطول/الزمن التي بُنيت منها.
...
هذا هو مغزى الوحدة المركّبة بأكمله. فالسرعة *هي* طول مقسوم على زمن. يتيح KUnit التنقّل بين الكمّيات الثلاث — الطول
والزمن والسرعة — بـ `*` و`/` بسيطين، وكل نتيجة **محكومة بالنوع** بقوّة. لن تحتاج أبدًا إلى بناء
