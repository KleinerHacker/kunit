...
`length · time⁻¹` (`m/s`)। इसलिए `KSpeedUnitInstance` ठीक दो पदों के एक `KMixedUnitInstance` को लपेटता है — घातांक `+1`
पर एक `KDistanceUnit.BASE` (मीटर) और घातांक `-1` पर एक `KTimeUnit.BASE` (सेकंड)। मान सदैव मीटर प्रति सेकंड में
प्रसामान्यीकृत संग्रहित होता है, चाहे इसे किस इकाई या लंबाई/समय संयोजन से बनाया गया हो।

## एक चाल बनाना

चाल एक **लंबाई-प्रति-समय व्यंजक** के रूप में बनाई जाती है, जैसे `10 of kilo.meters / hours` या
`100 of meters / (10 of seconds)` — दोनों एक `KSpeedUnitInstance` देते हैं। इसे किसी भी लंबाई-प्रति-समय टेम्पलेट में
वापस पढ़ें (`v into (kilo.meters / hours)`)। जानबूझकर `metersPerSecond` या
...
यही तो निर्मित इकाई का पूरा उद्देश्य है। एक चाल *होती है* एक लंबाई भाग एक समय। KUnit आपको तीनों राशियों — लंबाई, समय और
चाल — के बीच सादे `*` और `/` से आवागमन देता है, और हर परिणाम **प्रबल-प्रकार** होता है। आपको कभी कोई कच्चा
`KMixedUnitInstance` स्वयं बनाना या खोलना नहीं पड़ता।
...
या **आयतन** (`m³`) लंबाई नहीं है, इसलिए `area / time` `m²/s` होगा, चाल नहीं — संकारक चुपचाप गलत मान लौटाने के बजाय
`IllegalStateException` फेंकता है। ऐसा मध्यवर्ती जानबूझकर बनाने के लिए, किसी संकार्य को
