...
द्रव्यमान समूह द्रव्यमान की एक मात्रा को मॉडल करता है। यह एक **सादा, एक-विमीय** समूह है (दूरी समूह की तरह कोई
घातांक-विशेषीकृत उपप्रकार नहीं, और समय समूह की तरह कोई `Duration` समर्थन नहीं): `KMassUnitInstance`
...
`kilo.grams` है, अर्थात् ग्राम पर लागू SI उपसर्ग `kilo`। ग्राम के हर दशमलव परिमाण (मिलीग्राम, किलोग्राम, …) तक उसी
सामान्य तरीके से SI उपसर्गों के माध्यम से पहुँचा जाता है।
...
प्रत्येक `Token` एक मान-1 `KMassUnitInstance` है जो `of` (निर्माण) और `into` (पठन) के साथ प्रयुक्त होता है।
...
`==`, `!=`, `<`, `<=`, `>`, `>=` दो `KMassUnitInstance` मानों के प्रसामान्यीकृत `value` (ग्राम) की तुलना करते हैं।
`equals` प्रसामान्यीकृत मात्रा से होता है, इसलिए `(1 of kilo.grams) == (1000 of grams)`।

## `pow` से घात

infix `pow` संकारक से किसी मान को एक पूर्णांक घात तक उठाएँ (Kotlin में कोई अतिभारयोग्य `^` नहीं)। द्रव्यमान समूह के लिए
`pow` एक सामान्य `KMixedUnitInstance` लौटाता है (द्रव्यमान के पास कोई विमायुक्त घात प्रकार नहीं):
...
द्रव्यमान **कोई भी** परिमाण स्वीकारता है, इसलिए हर SI उपसर्ग बिल्डर (`quetta` … `quecto`) को हर द्रव्यमान इकाई के साथ
गुण पहुँच के माध्यम से जोड़ा जा सकता है। किलोग्राम ठीक `kilo.grams` है; मिलीग्राम
`milli.grams` है।
