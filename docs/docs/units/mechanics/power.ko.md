...
전력은 기술적으로 여러 주제 영역에 걸쳐 나타나는 **하나의** 물리량입니다. 이 페이지는 그 *역학적* 해석 (`P = F · v`)을 설명합니다. 동일한 Kotlin 그룹은 다른 영역에서도
[전력 (전기)](../electrical/power.md)와 [전력 (열역학)](../thermodynamics/power.md)에서 문서화되어 있습니다.
