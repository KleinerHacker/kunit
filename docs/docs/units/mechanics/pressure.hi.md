...
`+1` पर, `KDistanceUnit.BASE` (मीटर) `-1` पर, और `KTimeUnit.BASE` (सेकंड) `-2` पर। बल की तरह, संग्रहित मान कच्चा
ग्राम-आधारित घटक मान है, और पास्कल में पठन एक स्थिर गुणक से विभाजित होते हैं।

## एक दाब बनाना

दाब को `force / area` से, या किसी नामित टोकन से बनाएँ। नामित इकाइयाँ मान-1 टोकन के रूप में बचती हैं (`of`/`into` के साथ
प्रयुक्त):
