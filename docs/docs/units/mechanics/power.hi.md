...
शक्ति तकनीकी रूप से **एक** राशि है जो कई विषय‑क्षेत्रों में प्रकट होती है। यह पृष्ठ इसके *यांत्रिक* पठन (`P = F · v`) का
वर्णन करता है। वही Kotlin समूह अन्य क्षेत्रों के लिए
[शक्ति (विद्युत)](../electrical/power.md) और [शक्ति (ऊष्मागतिकी)](../thermodynamics/power.md) में प्रलेखित है।
