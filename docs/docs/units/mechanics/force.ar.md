...
الحزمة: `org.pcsoft.framework.kunit.mechanic.force`
...
`+1`، و`KTimeUnit.BASE` (ثانية) عند `-2`. ولأنّ مكوّن الكتلة في المكتبة مُطبَّع إلى **الغرامات** (لا الكيلوغرامات)، فإنّ
النيوتن أكبر 1000× من الأساس الخام للمكوّنات؛ القيمة المخزّنة هي قيمة المكوّن الخام، والقراءات بالنيوتن تُقسَم على ذلك
المعامل الثابت.
