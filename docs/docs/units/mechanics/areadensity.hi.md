...
संघटन `mass · length⁻²` (`kg/m²`)। `KAreaDensityUnitInstance` दो पदों के एक `KMixedUnitInstance` को लपेटता है —
`KMassUnit.BASE` (ग्राम) `+1` पर और `KDistanceUnit.BASE` (मीटर) `-2` पर। संग्रहित मान कच्चा ग्राम-आधारित घटक मान है;
kg/m² में पठन एक स्थिर गुणक से विभाजित होते हैं।

## एक क्षेत्रीय घनत्व बनाना

घनत्व की तरह, क्षेत्रीय घनत्व का **कोई नंगा टोकन नहीं** — हर वर्तनी (kg/m², g/mm², …) एक अनुपात है। इसे एक व्यंजक के रूप
में या प्रकार-युक्त `mass / area` संकारक के माध्यम से बनाएँ, और ऐसे व्यंजक के विरुद्ध `into`
से वापस पढ़ें:
